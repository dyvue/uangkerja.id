export default {
  ...
  head: {
    ...
    meta: [
      ...
      { property:"og:image", content:"/img/logo-profile.jpg"},
      ...
      { property:"twitter:image", content:"/img/logo-profile.jpg"},
      { property:"twitter:image:src", content:"/img/logo-profile.jpg"},
